...
import { ArrowLeft, TrendingUp, Calendar, MapPin, Ruler, Flag, Shield, Award, ExternalLink, UserCheck } from "lucide-react";
          ...
          <div className="md:col-span-2 p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-8 text-sm">
              ...
              <div className="flex justify-between border-b border-gray-100 pb-2">
                ...
                <span className="font-medium text-gray-900 flex items-center gap-1"><Ruler size={12} /> 1,82 m</span>
              </div>
              <div className="flex justify-between border-b border-gray-100 pb-2">
              ...
              <div className="flex justify-between border-b border-gray-100 pb-2">
                ...
                <span className="font-medium text-gray-900">Adidas</span>
              </div>
              <div className="flex justify-between border-b border-gray-100 pb-2">
        ...
        <div className="lg:col-span-1 bg-white border border-gray-200 rounded-lg shadow-sm p-6">
          ...
          {player.career_stats && (
            <div className="mb-4">
              ...
              <p className="text-xs text-gray-600">{player.career_stats}</p>
            </div>
          )}
      ...
      {player.contract_url && (
        <section className="max-w-6xl mx-auto px-4 w-full mb-12">
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
            <h2 className="text-lg font-bold text-gray-900 mb-4 border-b border-gray-200 pb-2 flex items-center gap-2">
              <UserCheck className="text-amber-500" size={20} /> Official Contract & Representation
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {!player.contract_signed && (
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                  ...
                  >
                    <UserCheck size={18} /> Sign Contract
                  </button>
                </div>
              )}
            </div>
